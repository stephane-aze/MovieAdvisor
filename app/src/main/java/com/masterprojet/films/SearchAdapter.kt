...
abstract class SearchAdapter<T : SearchAdapter.Searchable>(private val searchableList: MutableList<T>) :
            ...
            override fun performFiltering(constraint: CharSequence?): FilterResults {
                ...
                if (constraint.isNullOrBlank()) {
                    ...
                    val searchResults = originalList.filter {
                        it.getSearchCriteria().contains(constraint.toString().toLowerCase(
                        Locale.ROOT)) }
